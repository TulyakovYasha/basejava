...
//
//        resume.contacts.put(ContactType.PHONE, " ");
//        resume.contacts.put(ContactType.MOBILE, "+7(921) 855-0482");
//        resume.contacts.put(ContactType.HOME_PHONE, "7-73-20");
...
//
//        AbstractSection experience1 = new Organization("Java Online Projects", "url", Arrays.asList(new Experience.ExperienceInfo(2013, Month.OCTOBER, "Автор проекта.", "Создание, организация и проведение Java онлайн проектов и стажировок.")));
//        AbstractSection experience2 = new Organization("Wrike", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2014, 10, 1), LocalDate.of(2016, 1, 1), "Старший разработчик (backend)", "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO."))) ;
//        AbstractSection experience3 = new Organization("RIT Center", "url",Arrays.asList(new ExperienceInfo(LocalDate.of(2012, 4, 1), LocalDate.of(2014, 10, 1), "Java архитектор", "Организация процесса разработки системы ERP для разных окружений: релизная политика, версионирование, ведение CI (Jenkins), миграция базы (кастомизация Flyway), конфигурирование системы (pgBoucer, Nginx), AAA via SSO. Архитектура БД и серверной части системы. Разработка интергационных сервисов: CMIS, BPMN2, 1C (WebServices), сервисов общего назначения (почта, экспорт в pdf, doc, html). Интеграция Alfresco JLAN для online редактирование из браузера документов MS Office. Maven + plugin development, Ant, Apache Commons, Spring security, Spring MVC, Tomcat,WSO2, xcmis, OpenCmis, Bonita, Python scripting, Unix shell remote scripting via ssh tunnels, PL/Python")));
//        AbstractSection experience4 = new Organization("Luxoft (Deutsche Bank)", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2010, 12, 1), LocalDate.of(2012, 4, 1), "Ведущий программист", "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части CRM. Реализация RIA-приложения для администрирования, мониторинга и анализа результатов в области алгоритмического трейдинга. JPA, Spring, Spring-MVC, GWT, ExtGWT (GXT), Highstock, Commet, HTML5.")));
//        AbstractSection experience5 = new Organization("Yota", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2008, 6, 1), LocalDate.of(2010, 12, 1), "Ведущий специалист", "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования, статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/ Jython, Django, ExtJS)")));
//        AbstractSection experience6 = new Organization("Enkata", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2007, 3, 1), LocalDate.of(2008, 6, 1), "Разработчик ПО", "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining).")));
//        AbstractSection experience7 = new Organization("Siemens AG", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2005, 1, 1), LocalDate.of(2007, 2, 1), "Разработчик ПО", "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix).")));
//        AbstractSection experience8 = new Organization("Alcatel", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(1997, 9, 1), LocalDate.of(2005, 1, 1), "Инженер по аппаратному и программному тестированию", "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM).")));
//
//        List<Organization> expirienceAbstractSections = new ArrayList<>();
...
//
//        List<Organization> educationAbstractSections = new ArrayList<>();
//        AbstractSection education1 = new Organization("Coursera", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2013, 3, 1), LocalDate.of(2013, 5, 1), "Functional Programming Principles in Scala\" by Martin Odersky", null)));
//        AbstractSection education2 = new Organization("Luxoft", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2011, 3, 1), LocalDate.of(2011, 4, 1), "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"", null)));
//        AbstractSection education3 = new Organization("Siemens AG", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(2005, 1, 1), LocalDate.of(2005, 4, 1), "3 месяца обучения мобильным IN сетям (Берлин)", null)));
//        AbstractSection education4 = new Organization("Alcatel", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(1997, 9, 1), LocalDate.of(1998, 3, 1), "6 месяцев обучения цифровым телефонным сетям (Москва)", null)));
//        AbstractSection education5 = new Organization("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(1993, 9, 1), LocalDate.of(1996, 7, 1), "Аспирантура (программист С, С++)", null), new ExperienceInfo(LocalDate.of(1987, 9, 1), LocalDate.of(1993,7,1), "Инженер (программист Fortran, C)", null)));
//        AbstractSection education6 = new Organization("Заочная физико-техническая школа при МФТИ", "url", Arrays.asList(new ExperienceInfo(LocalDate.of(1984, 9, 1), LocalDate.of(1987, 6, 1), "Закончил с отличием", null)));
...
//        resume.sections.put(SectionType.EXPERIENCE, new OrganizationSection(educationAbstractSections));
//        resume.sections.put(SectionType.EDUCATION, new OrganizationSection(educationAbstractSections));
//
//        System.out.println(resume.toString());
//        System.out.println(resume.contacts.entrySet());
//        System.out.println(resume.sections.toString());
//    }
//}
